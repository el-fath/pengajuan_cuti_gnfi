...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
          	<form role="form" action="proses/notebrg2.php" enctype="multipart/form-data" method="POST">
                <div class="form-group">
                    <input type="hidden" name="id_pbarang"  class="form-control" value="<?php echo $r['id_pbarang']; ?>" />
                  <textarea name="note2" value="<?php echo $r['note2']; ?>" class="form-control" placeholder="write you note here"></textarea>
                </div>
