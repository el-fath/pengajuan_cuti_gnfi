...
if(isset($_POST['btnUpload'])){
	...
	if($eror == true){
		...
		if(move_uploaded_file($_FILES['berkas']['tmp_name'], $folder.$file_name)){
			...
			$catat = mysqli_query($conn,'insert into pengadaan_barang values (NULL, "'.$id_pegawai.'", "'.$id_kategori.'" ,"'.$nama_barang.'", "'.$tgl_pengajuan.'", "'.$file_name.'" ,"'.$alasan.'","Belum dikonfirmasi","","","","")') or die(mysqli_error($conn));
